...
from merge.pipeline import _emit, merge_datasets, preflight_merge


def test_merge_progress_callback_failure_propagates() -> None:
    ...
    with pytest.raises(Cancelled, match="cancelled"):
        _emit(cancel, stage="merge", progress=0.5)
